...
public partial class FrontOffice_Login : System.Web.UI.Page
{
        ...
        try
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    //Response.Cookies["CookiesUtilizador"].Value = TextBox2.Text;
                    //Response.Cookies["CookiesUtilizador"].Expires = DateTime.Now.AddMinutes(1);
